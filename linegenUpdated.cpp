...
bool saveFile() {
	//Creates new file for appending and overwriting data
	ofstream savedFile ("saveData.txt", ios::out);
...
//Using a loop, write in some data

//Load a file
bool loadFile() {
	//Loads a file for reading
	ifstream loadFile ("saveData.txt", ios::in);
	...
	//Overwrites the data by reading one string, can be easily used in a loop for arrays
	//loadFile >> someVariable;
